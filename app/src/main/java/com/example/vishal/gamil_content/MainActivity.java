    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<Message>> {
        ...
        MakeRequestTask(GoogleAccountCredential credential) {
            ...
            mService = new com.google.api.services.gmail.Gmail.Builder(
                    ...
                    .setApplicationName("Gmail_content")
                    .build();
        }
        ...
        protected List<Message> doInBackground(Void... params) {
            try {
                return listMessagesWithLabels1();
            } catch (Exception e) {
                mLastError = e;
                cancel(true);
                return null;
...
//        }
        ...
        public  List<Message> listMessagesWithLabels1() throws IOException {
            String user = "me";
            ...
            while (response.getMessages() != null) {
                ...
                if (response.getNextPageToken() != null) {
                    ...
                    response = mService.users().messages().list(user).setLabelIds(Arrays.asList("INBOX"))
        ...
        protected void onPostExecute(List<Message> output) {
            ...
            if (output == null || output.size() == 0) {
              ...
              //  output.add(0, "Data retrieved using the Gmail API:");
                ...
                Log.e("mail_data: ",TextUtils.join("\n", output));
